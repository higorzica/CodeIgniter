...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-8 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Olá - Seja Bem-vindo 🤝 ! Eu Sou Higor Zica </h1>
      <p class="mb-8 leading-relaxed">Meu nome é Higor Zica, sou técnico em informática e bacharel em Admnistração. Sou fascinado por programação e principalmente pelo desenvolvimento web/mobile, estando sempre a procura de conhecimento e novos desafios.</p>
...
<section class="text-gray-600 body-font" id="projetos">
  <div class="container px-5 py-12 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">PROJETOS</h1>
    </div>
        ...
        <div class="p-4 lg:w-1/2">
            ...
            <img alt="team" class="flex-shrink-0 rounded-lg w-80 h-80 object-contain object-center sm:mb-0 mb-4" src="<?= base_url("projetos/" . $projeto->foto) ?>">
                <div class="flex-grow sm:pl-8">
                        <h2 class="title-font font-medium text-lg text-gray-900"><?= $projeto->titulo ?></h2>
